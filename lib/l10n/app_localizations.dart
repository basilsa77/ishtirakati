...
class AppLocalizations {
  ...
  static final _fallback = AppLocalizations._(const Locale('ar'), <
    String,
    String
  >{
    ...appMessagesAr,
    ...
    'cloudFirstCreateSuccess': 'تم إنشاء النسخة السحابية ومزامنتها بنجاح',
    ...
    'firestoreDiagnosticRest401': 'HTTP 401: رمز Firebase غير صالح أو لم يتجدد',
    ...
    'firestoreDiagnosticDnsFailed': 'تعذر حل اسم firestore.googleapis.com',
    ...
    'firestoreDiagnosticClientFailed': 'فشل عميل HTTPS قبل استلام استجابة',
    'firestoreDiagnosticNoUser': 'لا يوجد مستخدم Firebase مسجل',
    'firestoreDiagnosticTokenFailed': 'تعذر تجديد Firebase ID token',
    'firestoreDiagnosticUnexpected': 'فشل غير متوقع أثناء اختبار REST',
    ...
    'cloudQueuedLocally': 'تم حفظ النسخة محليًا وهي بانتظار المزامنة السحابية',
    ...
    'firestoreDiagnosticQueuedLocally': 'محفوظ محليًا وبانتظار الخادم',
    ...
    'cloudTimeout': 'استغرقت المزامنة وقتًا طويلًا. حاول مجددًا بعد لحظات.',
    'cloudFirebaseError': 'تعذرت المزامنة بسبب خطأ من Firebase ({code}).',
    ...
    'ui_f916d7d0556e': '{value0} تصنيفات',
  ...
  String money(num value, String currency, {int decimalDigits = 2}) {
    ...
    final symbol = currency == 'SAR' ? text('currencySar') : currency;
  ...
  static Future<AppLocalizations> load(Locale locale) async {
    ...
    final result = AppLocalizations._(
      Locale(language),
      raw.map((key, value) => MapEntry(key, value is String ? value : '$value'))
