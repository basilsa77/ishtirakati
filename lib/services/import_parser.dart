...
const List<_Service> _services = [
  ...
  _Service('Apple One', '🅰️', 'أخرى', ['apple one']),
  ...
  _Service('Snapchat+', '👻', 'أخرى', ['snapchat', 'سناب شات', 'سناب']),
  _Service('X Premium', '❌', 'أخرى', ['x premium', 'twitter']),
  _Service('Telegram Premium', '✈️', 'أخرى', ['telegram', 'تيليجرام', 'تلغرام']),
