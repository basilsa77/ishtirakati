...
const List<ServicePreset> kPresets = [
  ...
  ServicePreset('Duolingo Super', '🦉', 'تعليم'),
  ServicePreset('Nintendo Switch Online', '🍄', 'ألعاب'),
  ServicePreset('HungerStation Plus', '🍔', 'تسوق وتوصيل'),
  ServicePreset('تطبيق تأمل/لياقة', '🧘', 'رياضة وصحة'),
];
